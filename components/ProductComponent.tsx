...
const ProductComponent: React.FC<ProductComponentProps> = ({ imageUrl, imageAlt, title, description, precio, linkHref, linkAs }) => {
    return (
        <div className="w-full my-4 sm:w-1/2 max-w-[200px] mx-auto mt-4 bg-gray-100 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
